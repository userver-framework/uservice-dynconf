...
* `make docker-start-service` - does a `make install` and run service in docker environment
* `make docker-start-service-debug` - does a `make install-debug` and run service in docker environment
