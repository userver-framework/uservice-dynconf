...
// std::string checkSessionToken(const userver::components::ComponentContext& context, std::string token) {
//     std::string host = "locahost:8080";

//     userver::clients::http::Headers headers = {{"X-Ya-User-Ticket", token}};

//     suserver::clients::http::Client http_client_(context.FindComponent<userver::components::HttpClient>().GetHttpClient());
