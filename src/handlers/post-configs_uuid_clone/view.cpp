...
struct RequestData {
  ...
  Handler::HandleRequestJsonThrow(
    ...
    const auto copied_service = result.AsSingleRow<RequestData>(userver::storages::postgres::kRowTag);

    result = cluster_->Execute(
      userver::storages::postgres::ClusterHostType::kMaster,
      uservice_dynconf::sql::kInsertClonedVariable.data(),
