...
using ConfigId =
    userver::utils::StrongTypedef<class ConfigIdTag, int64_t, userver::utils::StrongTypedefOps::kCompareTransparent>;
...
struct storages::postgres::io::CppToUserPg<uservice_dynconf::models::Mode> {
    ...
    static constexpr userver::utils::TrivialBiMap enumerators = [](auto selector) {
        ...
        return selector()
            .Case(uservice_dynconf::models::ToString(Mode::kDynamicConfig), Mode::kDynamicConfig)
            .Case(uservice_dynconf::models::ToString(Mode::kKillSwitchEnabled), Mode::kKillSwitchEnabled)
            .Case(uservice_dynconf::models::ToString(Mode::kKillSwitchDisabled), Mode::kKillSwitchDisabled);
    };
};
